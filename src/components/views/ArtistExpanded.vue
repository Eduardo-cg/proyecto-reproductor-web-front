    ...
    <template v-else>
      ...
      >
        ...
        >
          ...
          <button
            class="page-btn"
            :disabled="trackPage >= trackTotalPages - 1"
            @click="goToTrackPage(trackPage + 1)"
          >
            <Icon
              name="chevron-right"
      ...
      >
        ...
        <div
          v-if="albumTotalPages > 1"
          class="pagination-controls"
        >
          <button
            class="page-btn"
            :disabled="albumPage === 0"
            @click="goToAlbumPage(albumPage - 1)"
          >
            <Icon
              name="chevron-left"
              size="12"
      ...
      <div
        v-if="tracks.length === 0 && albums.length === 0"
        class="empty-sub"
      >
